USE [TAX_SERVICES]
GO
/****** Object:  Table [dbo].[Medicare_Tax_Table]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Percentage_Method_Table_O1_HoH]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Percentage_Method_Table_O1_MFJ]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Percentage_Method_Table_O1_SorMFS]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Percentage_Method_Table_O2_HoH]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Percentage_Method_Table_O2_MFJ]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Percentage_Method_Table_O2_SorMFS]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Social_Security_Tax_Table]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Tax_Filing_Status]    Script Date: 9/11/2022 8:39:40 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Medicare_Tax_Table] ([Tax_Year], [Tax_Rate], [Additional_Tax_Rate], [Threshold_Wage]) VALUES (CAST(N'2022-01-01' AS Date), CAST(1.45 AS Decimal(18, 2)), CAST(0.90 AS Decimal(18, 2)), CAST(200000.00 AS Decimal(18, 2)))
GO
...
GO
INSERT [dbo].[Social_Security_Tax_Table] ([Tax_Year], [Tax_Rate], [Wage_Base_Limit]) VALUES (CAST(N'2022-01-01' AS Date), CAST(6.20 AS Decimal(18, 2)), CAST(147000.00 AS Decimal(18, 2)))
GO
