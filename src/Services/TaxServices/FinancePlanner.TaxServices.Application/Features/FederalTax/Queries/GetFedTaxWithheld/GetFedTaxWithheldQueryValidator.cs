...
{
    public class GetFedTaxWithheldQueryValidator : AbstractValidator<GetFedTaxWithheldQuery>
    {
        public GetFedTaxWithheldQueryValidator(IConfiguration configuration)
        {
